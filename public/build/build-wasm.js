...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'build-wasm.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'build-wasm.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'build-wasm.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "build-wasm.js.mem" : null;
...
var _nbOfPrimesFound = Module["_nbOfPrimesFound"] = function() { return Module["asm"]["_nbOfPrimesFound"].apply(null, arguments) };
